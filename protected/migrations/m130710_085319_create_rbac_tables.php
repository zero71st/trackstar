...
class m130710_085319_create_rbac_tables extends CDbMigration {
    ...
    public function up() {
        ...
        $this->addForeignkey('fk_auth_assignment_userid', 'tbl_auth_assignment', 'userid', 'tbl_user', 'id', 'CASCADE', 'RESTRICT'); // ต้องใส่ RESTRICT ในตำราใส่เป็น CASCADE ซึ่ง RUN ไม่ผ่าน
    }
